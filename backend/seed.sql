...
SELECT 'b67dc250-0a8f-4ab2-8a0b-8ef2b1fc2fb6', 'giovanni.limatola@gmail.com', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NOW()
WHERE NOT EXISTS (SELECT 1 FROM users WHERE email = 'giovanni.limatola@gmail.com');

INSERT INTO users (id, email, "passwordHash", "createdAt")
SELECT 'b848f99b-a95a-4921-9a49-73ef0b7d8646', 'ggiacobonep@gmail.com', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NOW()
...
BEGIN
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_latte_scramato, 200, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_latte_scramato);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_biscotti_misura_privolat, 30, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_biscotti_misura_privolat);
  ...
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_zucchine);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_philadelphia, 80, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_philadelphia);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_petto_di_pollo, 180, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_petto_di_pollo);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_panko, 30, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_panko);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_zucca, 200, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_zucca);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_frutta_sotto_vuoto, 2, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_frutta_sotto_vuoto);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_salmone_affumicato, 80, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_salmone_affumicato);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_valeriana, 50, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_valeriana);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_piadina, 80, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_piadina);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_fesa_di_tacchino, 60, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_fesa_di_tacchino);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_philadelphia, 25, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_philadelphia);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_uova, 2, 'unit'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_uova);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_funghi, 200, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_funghi);
  ...
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_pane_tostato);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_miele, 10, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_miele);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_noci, 15, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_noci);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_polpo, 300, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_polpo);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_patate, 200, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_patate);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_frutta_sotto_vuoto, 2, 'unit'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_frutta_sotto_vuoto);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_ricotta, 100, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_ricotta);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_spinaci, 200, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_spinaci);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_prosciutto_cotto, 50, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_prosciutto_cotto);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_crostini, 50, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_crostini);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_minestrone_leggerezza, 250, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_minestrone_leggerezza);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_riso, 50, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_riso);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_piselli, 150, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_piselli);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_roastbeef, 180, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_roastbeef);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_melanzane, 200, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_melanzane);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_patate, 200, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_patate);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_salmone, 200, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_salmone);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_pomodori_da_insalata, 150, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_pomodori_da_insalata);
  ...
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_hamburger_vegetale, 150, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_hamburger_vegetale);
  INSERT INTO meal_items (id, "mealId", "ingredientId", quantity, unit)
  SELECT gen_random_uuid(), v_meal_id, v_ing_tris_di_verdure, 200, 'gr'
  WHERE NOT EXISTS (SELECT 1 FROM meal_items WHERE "mealId" = v_meal_id AND "ingredientId" = v_ing_tris_di_verdure);
